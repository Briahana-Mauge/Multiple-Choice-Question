document.addEventListener('DOMContentLoaded', () => {
  const allTheWords = 'clown, acrobat, animal, trapeze, music, dancers, tightrope, jugglers, pets, tentarch, muscleman, circusmusic, tent, ring, sugar, silly,  magicians, unicycle, stunts, tigers, lions, elephants, popcorn, cottoncandy'.split(', ');
